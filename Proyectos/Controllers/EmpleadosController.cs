...
namespace Proyectos.Controllers
{
    public class EmpleadosController : Controller
    {
        ...
        public EmpleadosController(ProyectosDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string textoABuscar)
        {
            ...
            var empleados = from p in _context.Empleados select p;

            if (!String.IsNullOrEmpty(textoABuscar))
            {
                empleados = empleados.Where(p => p.Nombre.Contains(textoABuscar));
            }
